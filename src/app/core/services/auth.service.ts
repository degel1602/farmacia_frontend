...
// ─── Usuario de prueba (solo lado cliente) ────────────────────
const MOCK_USER: User = {
  id: 1,
  username: 'admin',
  fullName: 'Willian Pillaca',
  email: 'admin@galenosp.com',
  role: 'ADMIN',
};
