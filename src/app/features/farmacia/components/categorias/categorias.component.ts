...
import { CategoriaMedicamento } from '../../models/farmacia.models';
...
export class CategoriasComponent implements OnInit {
  ...
  categorias    = signal<CategoriaMedicamento[]>([]);
  ...
  loadCategorias(): void {
    ...
    this.medicamentoService.getCategorias().subscribe({
      next: (res) => { this.categorias.set(res.data); this.isLoading.set(false); },
  ...
  abrirEditar(cat: CategoriaMedicamento): void {
  ...
  confirmarEliminar(cat: CategoriaMedicamento): void {
